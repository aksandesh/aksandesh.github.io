...
$select="SELECT * FROM `baker_cat` where id=1";
$query=mysqli_query($con,$select);
$res=mysqli_fetch_assoc($query);

$select2="SELECT * FROM `baker_prod` where cat_id=1";
$query2=mysqli_query($con,$select2);

$select3="SELECT * FROM `baker_prod` where cat_id=2 LIMIT 1";
				...
				<div class="container">
					...
					<div class="float-right">
						...
						<ul class="h_search list_style">
							...
							<li class="sign-in"><a href="login/logout.php">sign-out<i class="fad fa-sign-in"></i></a></li>
						</ul>
						...
						<ul class="h_search list_style">
							...
							<li class="shop_cart"><a href="#"><i class="lnr lnr-cart"></i></a></li>
							<li><a class="popup-with-zoom-anim" href="#test-search"><i class="fa fa-search"></i></a></li>
							<li class="sign-in"><a href="login/login_form.php">sign-in<i class="fad fa-sign-in"></i></a></li>
						</ul>
					...
					<div class="col-lg-3 col-md-4 col-6">
						...
						<div class="cake_feature_item">
							...
							<div class="cake_img">
							 ...
							 <img  src="admin/uploads/<?php echo $res2['image']; ?>" width="300" height="200"  class="img-responsive" >   
							...
							<div class="cake_text">
								<h4><span><i class="fa fa-rupee"></i><?php echo $res2['price'];?></h4><span>
								<!--Strawberry Cupcakes-->
								<h3><a href="#" data-toggle="modal" data-target="#<?php echo $res2['id']; ?>"><?php echo $res2['title'];?></h3></a>
								<a class="pest_btn" href="javascript:;" prod_id=<?php echo $res2['id']; ?>>Add to cart</a>
...
$query2=mysqli_query($con,$select2); ?>
 ...
 <?php while($res2=mysqli_fetch_assoc($query2)){ ?>
					...
					<div class="modal fade" id="<?php echo $res2['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="Modal-label-1">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
						<h4 class="modal-title" id="Modal-label-1"><?php echo $res2['title'];?></h4>
					</div>
					<div class="modal-body">
						        		<div class="row product_d_price">
        			<div class="col-lg-6">
        				<div class="product_img"><img src="admin/uploads/<?php echo $res2['image']; ?>" alt="img01" class="img-responsive" /></div>
        			</div>
        			<div class="col-lg-6">
        				<div class="product_details_text">
        					 
        					<p><?php echo $res2['description']; ?> </p>
        					<h5>Price :<span><i class="fa fa-rupee"></i><?php echo $res2['price'];?></span></h5>
        				...
        				<div class="s_we_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							...
        							<p>The pleasure lies not in the cookies, but in the pattern the crumbs make when the cookies</p>
        						</div>
        					</div>
        				</div>
        			</div>
        				...
        				<div class="s_we_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							...
        							<p>The pleasure lies not in the Cupcakes, but in the pattern the crumbs make when the Cupcakes.</p>
        						</div>
        					</div>
        				</div>
        			</div>
        				...
        				<div class="s_we_item">
        					<div class="media">
        						...
        						<div class="media-body">
        							...
        							<p>The pleasure lies not in the cakes, but in the pattern the crumbs make when the cakes.</p>
        						</div>
        					</div>
        				</div>
        			</div>
        		...
        		<div class="row our_chef_inner">
        			<div class="col-lg-3">
        				<div class="chef_text_item">
        					<div class="main_title">
								<h2>Our Chefs</h2>
								<p>Chef Sanjeev Kapoor. The Man who knows how to play on the shelf, in the kitchen and outside..</p>
							</div>
        				</div>
        			</div>
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					...
        					<a href="#"><h4>Michelle Pfeiffer</h4></a>
        			...
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					...
        					<a href="#"><h4>Michael Douglas</h4></a>
        					<h5>Expert in Cake Making</h5>
        				</div>
        			</div>
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					...
        					<a href="#"><h4>Michael Jackson</h4></a>
        					<h5>Expert in Cake Making</h5>
        				</div>
        			</div>
        		</div>
       				...
       				<div class="col-lg-4 col-md-6">
       					<div class="l_news_image">
       						...
       						<div class="l_news_hover">
       							...
       							<a href="#"><h4>The cookies that were always in the sack with the bread,
								 .</h4></a>
       						</div>
       					</div>
       				</div>
       				<div class="col-lg-4 col-md-6">
       					<div class="l_news_item">
       						...
       						<div class="l_news_text">
       							...
       							<p>The cookies that were always in the sack with the bread, we just gobbled straight down.</p>
       						</div>
       					</div>
       				</div>
       				<div class="col-lg-4 col-md-6">
        			...
        			<div class="row footer_wd_inner">
        				<div class="col-lg-3 col-6">
        					...
        					<aside class="f_widget f_about_widget">
        						...
        						<p>Baking the difference. We create delicious memories. Just like home. Let us keep Your cookie jar filled</p>
        						<ul class="nav">
        							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
        							<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
        							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<!-- var prod_title= $(this).closest('.pi-pic').siblings('.titleclass').find('p.title').html();
 <!--  var prod_price= $(this).closest('.pi-pic').siblings('.titleclass').find('p.price').html(); -->
 <!--   var prod_image= $(this).closest('.pi-pic').find('.imagediv').find('.imageclass').html(); -->
  	...
  	$.ajax({
        ...
        success:function(result){
		 ...
		 document.getElementById('countdata').innerHTML = res.count;
        Swal.fire(
		  res.msg 
