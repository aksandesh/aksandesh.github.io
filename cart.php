				...
				<div class="table-responsive">
					<table class="table">
					  ...
					  <?php  while($res=mysqli_fetch_assoc($query)){ ?>
							<tr>
								<td>
									<img src="admin/uploads/<?php echo $res['image']; ?>" height="120" width="120" class="mt-2">
								</td>
								<td><?php echo $res['title']; ?></td>
								<td><p  class="price" name="price"><?php echo $res['price']; ?> </p></td>
								<td>
								
									<input class="quantity"  type="number" name="quantity[]" class="form-control" value="1" min="1"   />
								...
								<td><p class="total"><?php echo $res['price'];?></p></td>
								<td><a href="javascript:;" name="prodid" class="deletefromcart" prod_id="<?php echo $res['id'];?>">Delete </a></td>
							...
							<tr>
								...
								<td> <input type="hidden" name="productid[]" class="form-control" value="<?php echo $res['id'];?>" > </td>
							</tr>
       			...
       			<div class="row cart_total_inner">
        			...
        			<div class="col-lg-5">
        				<div class="cart_total_text">,
							...
							<div class="sub_total"> <h5> Sub Total :<span><input type="text" class="grand" name="grand_total" id="grandtotal" style="font-size:15px;"  readonly ></span></h5></div>
        					<!--<div class="sub_total">
							...
							<input type="submit" value="Proceed to Checkout" align="center" class=" pest_btn  btn btn-border btn-info" >
						</form>
...
<br>
<br>
					<h4 align="center"><b>Cart is Empty !</b></h4>
...
var gtotal=$('.total');
	...
	{
		grandtotal+=Number(gtotal[i].innerHTML);
    }
...
$('document').ready(function(){ $('#grandtotal').val(grandtotal);

	$('#place_order').attr('href',"checkout.php?grand_total="+grandtotal);
 
});

$('.quantity').change(function(){
	
	var price=$(this).closest('td').siblings().find('.price').html();
	
	var quantity=$(this).val();
	var total=(quantity * price);
	
	$(this).closest('td').siblings().find('.total').html(total);
