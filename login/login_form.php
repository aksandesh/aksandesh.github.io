        	...
        	<div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
						...
						<img src="assets/img/backgrounds/logo-3.png" alt="">
                ...
                <div class="row register-form">
                    <div class="col-sm-4 col-sm-offset-1">
						<form role="form" action="insert.php" method="post" class="r-form">
	                    	<div class="form-group">
	                    		<label class="sr-only" for="r-form-first-name">First name</label>
	                        	<input type="text" name="firstname" placeholder="First name..." class="r-form-first-name form-control" id="r-form-first-name">
	                        </div>
	                        <div class="form-group">
	                        	<label class="sr-only" for="r-form-last-name">Last name</label>
	                        	<input type="text" name="lastname" placeholder="Last name..." class="r-form-last-name form-control" id="r-form-last-name">
	                        </div>
							<div class="form-group">
	                        	<label class="sr-only" for="r-form-last-name">Contact Number</label>
	                        	<input type="text" name="contact" placeholder="Contact number..." class="r-form-last-name form-control" id="r-form-last-name">
	                        </div>
	                        
	                        <div class="form-group">
	                        	<label class="sr-only" for="r-form-about-yourself">Complete Address</label>
                ...
                <div class="row login-form">
                    <div class="col-sm-4 col-sm-offset-1">
						<form role="form" action="logincheck.php" method="post" class="l-form">
	                    	<div class="form-group">
