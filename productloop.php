...
$select="SELECT * FROM `baker_prod` where `cat_id`='$catid'";
        		...
        		<div class="cake_feature_row row">
					...
					<div class="col-lg-3 col-md-4  col-6">
						<div class="cake_feature_item">
							<div class="cake_img">
								<img src="admin/uploads/<?php echo $res['image']; ?>" width="300" height="200"  alt="">
							</div>
							<div class="cake_text">
								<h4><span><i class="fa fa-rupee"></i><?php echo $res['price']; ?></h4></span>
								<h3> <a href="#" data-toggle="modal" data-target="#<?php echo $res['id']; ?>"><?php echo $res['title']; ?></h3></a>
								<a  href="javascript:;" class="pest_btn" prod_id=<?php echo $res['id']; ?> >Add to cart</a>
							</div>
						</div>
					</div>
					<?php } ?>
...
$query=mysqli_query($con,$select); ?>
 ...
 <?php while($res=mysqli_fetch_assoc($query)){ ?>
					...
					<div class="modal fade" id="<?php echo $res['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="Modal-label-1">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
						<h4 class="modal-title" id="Modal-label-1"><?php echo $res['title'];?></h4>
					</div>
					<div class="modal-body">
						<div class="row product_d_price">
        			<div class="col-lg-6">
        				<div class="product_img"><img src="admin/uploads/<?php echo $res['image']; ?>" alt="img01" width="200" height="200" class="img-responsive" /></div>
        			</div>
        			<div class="col-lg-6">
        				<div class="product_details_text">
        					 
        					<p><?php echo $res['description']; ?> </p>
        					<h5>Price :<span><i class="fa fa-rupee"></i><?php echo $res['price'];?></span></h5>
					...
					<a class="pest_btn  " href="javascript:;" prod_id=<?php echo $res['id']; ?>>Add to cart</a>
...
// to send multiple data in ajax data:{prod_id:prod_id,msg:msg},
</script>
